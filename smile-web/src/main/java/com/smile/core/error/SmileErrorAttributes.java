...
public class SmileErrorAttributes
        implements ErrorAttributes, HandlerExceptionResolver, Ordered {

    private static final String ERROR_ATTRIBUTE = SmileErrorAttributes.class.getName()
            + ".ERROR";
    ...
    private void addErrorMessage(Map<String, Object> errorAttributes, Throwable error) {
        if (error instanceof BussinessException) {
            errorAttributes.put("code", ((BussinessException) error).getCode());
            errorAttributes.put("errorMessage", ((BussinessException) error).getErrorMessage());
        }
